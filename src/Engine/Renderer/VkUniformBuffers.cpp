...
namespace VkRenderer
{
    ...
    void VkUBuffer::createDescriptorSets(VkDescriptorSetLayout descriptorSetLayout, std::vector<VkImage> swapChainImages, VkDevice device,VkImageView textureImageView, VkSampler textureSampler)
    {
